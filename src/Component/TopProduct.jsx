...
import Img1 from '../../src/assets/Image/top1.jpg'
          ...
          >
            ...
            <div className="h-[150px]">
              <img
                src={data.img}
                alt=""
                className="max-w-[140px] block mx-auto transform -translate-y-20 group-hover:scale-105 duration-300 drop-shadow-md mt-4"
              />
            </div>
